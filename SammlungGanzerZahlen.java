...
public class SammlungGanzerZahlen
{
    ...
    /**
     * Konstruktor fï¿½r Objekte der Klasse SammlungGanzerZahlen der angegebenen Kapazitaet (= maximale 
...
//        return false;
     ...
     * @throws IndexOutOfBoundsException falls ein Index Größer als die Arraygröße angefragt wird
     */
...
//            return 9999;
     ...
     *         ausgegeben und die Zahl 9999 zurueckgegeben.
     *	@throws Wenn das Array Leer ist, wird ein IllegalArgumentException zurückgegeben
     */
...
//            return 9999;
     ...
     * @throws ArrayStoreException Wenn die Zahl nicht eingefügt werden kann
     */
    public boolean fuegeZahlEin(int neueZahl, int index) throws ArrayStoreException
    {
        if (anzahl<ganzeZahlen.length) {
        	...
        	throw new ArrayStoreException();
//            System.err.println("Das Array ist voll, es kann leider keine Zahl eingefÃ¼gt werden.");
//            return false;
        }
    }
     ...
     * @return groesste Zahl im Array. Gibt 9999 zurï¿½ck, falls es keine groesste Zahl gibt.
